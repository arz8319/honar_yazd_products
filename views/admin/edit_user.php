...
<head>
    <meta charset="UTF-8">
    <title>پنل مدیریت - ویرایش کاربر</title>
...
<body>
    ...
    <div class="content">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                <label for="password" class="form-label">رمز عبور (برای تغییر وارد کنید)</label>
                <input type="password" name="password" id="password" class="form-control">
            </div>
            <div class="mb-3">
                <label for="role" class="form-label">نقش</label>
                <select name="role" id="role" class="form-control">
                    <option value="customer" <?php echo $user['role'] === 'customer' ? 'selected' : ''; ?>>مشتری</option>
